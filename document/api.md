...
- Request Endpoint:
http://{server-domain}/api/product/goods-exchange-log/address/55925bc58fd1250647000001
...
- Request Endpoint:
http://{server-domain}/api/questionnaire/55d6cb8be9c2fb022c8b4579&channelId=54d9c155e4b0abe717853ee1&openId=54d9c155e4b0abe717853ee1
...
- Request Endpoint:
http://{server-domain}/api/content/questionnaire/55d6cb8be9c2fb022c8b4579
...
```
http://{server-domain}/api/game/game/{gameId}
```
...
```
http://wm.com/api/game/game/55efb2e8971374151a8b4567
```
...
```
{
    "id": "55efb2e8971374151a8b4567",
    "name": "猿粪" ,
    "rule": "在有限的时间内从一堆杂乱的字母中按顺序挑出指定的编程语言所需字母并正确组合,完成的语言越多分数越高, 反之则低",
    "poster":  "http://wm.com/poster.jpg",
    "pictures": [
        'http://wm.com/1.jpg',
        'http://wm.com/2.jpg',
        'http://wm.com/3.jpg',
    ...
    "qrcodes" :[
        {
            "id":  "55efb2e8971374151a8b4567",
            "channelId":  "55efb2e8971374151a8b4567",
            "url":  "http://wm.com/3.jpg",
            "origin": "wechat"
        },
        {
            "id":  "55efb2e8971374151a8b4567",
    ...
    "setting": "[
            {
                "step": "1",
                "name": "name 1",
                "words": ["c++", "stl", "const", "new", "malloc", "delete"],
                "time":  "60"
            },
            {
                "step": "2",
                "name": "name 2",
                "words": ["java", "String", "list", "new", "public", "spring"],
                "time":  "90"
            }
        ]",
    "isPublished": true,
...
```
http://{server-domain}/api/game/game/publish
```
...
| Name | Type | Required | Example | Description |
| ---- | ---- | -------- | ------- | ----------- |
| id | string | yes | 55efb2e8971374151a8b4567 | 游戏ID |
| isPublished | bool | yes | true | 是否发布 |

- Request Example

```
PUT
http://wm.com/api/game/game/publish
...
```
http://{server-domain}/api/game/game/setting
```
...
| ---- | ---- | -------- | ------- | ----------- |
| id | string | yes | 55efb2e8971374151a8b4567 | 游戏ID |
| setting | string | yes |  | 游戏关卡设置 |

- Request Example

```
PUT
http://wm.com/api/game/game/setting
...
- Request Endpoint
http://{server-domain}/api/game/games

- Request Parameters:

| Name | Type | Required | Example | Description |
| ---- | ---- | -------- | ------- | ----------- |
| per-page | int | no | 20 | 每页条数默认20 |
| page | int | no | 1 | 页数默认1 |

- Request Example

```
http://wm.com/api/{TBD}/games
```
...
```
{
    "items": [
        {
            ...
            "url": "http://wm.com/webapp/game/game/index?gameId=55f67401d6f97f53798b4568",
            "setting": "[\n                {\"step\": 1, \"name\": \"编程语言\", \"words\": [\"java\", \"c++\", \"ruby\", \"php\", \"go\", \"c#\"], \"time\": 40},\n                {\"step\": 2, \"name\": \"数据库\", \"words\": [\"sqlserver\", \"mysql\", \"oracle\", \"mongo\", \"redis\", \"memcache\"], \"time\": 30},\n                {\"step\": 3, \"name\": \"前端\", \"words\": [\"html\", \"js\", \"css\", \"sass\", \"coffee\", \"less\"], \"time\": 20}\n            ]",
            "isPublished": false,
            "qrcodes": [
                {
                    "id": "55f685c4d6f97f7e118b4569",
                    "channelId": "54d9c155e4b0abe717853ee1",
                    "qiniuKey": "55f685c4d6f97f7e118b4569.png",
                    "origin": "wechat",
                    "url": "http://vincenthou.qiniudn.com/55f685c4d6f97f7e118b4569.png"
                }
            ]
        }
    ],
    "_links": {
        "self": {
            "href": "http://wm.com/api/game/games?page=1"
        }
    },
    "_meta": {
        "totalCount": 1,
...
- Request Endpoint
http://{server-domain}/api/game/game/qrcode

- Request Parameters:

| Name | Type | Required | Example | Description |
| ---- | ---- | -------- | ------- | ----------- |
| channels | array | Yes | ["54d9c165e450abe71785467", "54d9c165e450abe71785567"] | 渠道账号id |
| gameId | string | Yes | 54d9c165e450abe71785467 | 游戏id |

- Request Example

```
http://wm.com/api/{TBD}/game-logs
```
...
### check chance for member

- Request method
GET

- Request Endpoint
http://{server-domain}/api/game/game-log/stats-member

- Request Parameters:

| Name | Type | Required | Example | Description |
| ---- | ---- | -------- | ------- | ----------- |
| gameId | string | Yes | 54d9c155e4b0abe717853ee1 | 游戏id |
| per-page | int | No | 20 | 每页条数默认20 |
| page | int | No | 1 | 页数默认1 |
| startTime | int | No | 1427712453000 | 毫秒时间戳 |
| endTime | int | No | 1427712453000 | 毫秒时间戳 |
| memberId | string | No | 55efb2e8971374151a8b4567 | member Id |
...
```
http://{server-domain}/api/game/game-logs
```
...
| Name | Type | Required | Example | Description |
| ---- | ---- | -------- | ------- | ----------- |
| gameId | string | yes | 55efb2e8971374151a8b4567 | 游戏ID |
| channelId | string | yes | 55efb2e8971374151a8b4567 | 渠道账号Id |
| openId | string | yes | 55efb2e8971374151a8b4567 | 社交账号Id |
| origin | string | yes | weibo | 社交渠道 ||
| data | json | yes | |  |
...
```
POST
http://wm.com/api/game/game-logs

{
    "gameId": "55efb2e8971374151a8b4567",
    "channelId": "54d9c155e4b0abe717853ee1",
    "openId" :"oC9Aesw8sNMBkr7JLJVOgrQ14xjQ",
    "origin": "微信",
    "data": {
        "level": "闯关数",
        "score": 122
...
```
{
    "items": [
        {
            "id": "55efb2e8971374151a8b4567",
            "gameId": "55efb2e8971374151a844567",
            "player": {
                "channelId": "54d9c155e4b0abe717853ee1",
                "openId": "oC9AesxUY47JuT1iv7mZc3BIgIdc",
                "name": "会飞的小星星",
                "origin": "wechat"
            },
            "data": {
...
```
### Get statsGameLog list

- Request method
GET

- Request Endpoint
http://{server-domain}/api/game/stats-game-logs
...
```
http://wm.com/api/game/stats-game-logs
```
...
Domain:
 stage: https://sandbox-api.quncrm.com

 prod: https://api.quncrm.com

### Game shake

#### Get game shake info with out member suitable

- Request Method:
GET

- Request Endpoint:
http://{server-domain}/games/{gameId}
...
```
https://sandbox-api.quncrm.com/games/5618cb67d6f97f6e5f8b4569
```
...
| Code | Message |
| ---- | ---- |
| 10001 | game doesn't exists |
| 10003 | invalid game setting |
| 20001 | unpublish game |
...
```
{
    "id": "5629afd6d6f97f1f048b456e",
    "name": "摇红包",
    "rule": "通过微信手机摇一摇，在指定的时间段内，轻松摇一摇既有机会得到红包。",
    "poster": "/images/game/shake/poster.png",
    "pictures": [
        "/images/game/shake/1.jpeg",
        "/images/game/shake/2.jpg",
        "/images/game/shake/3.jpg",
        "/images/game/shake/4.jpg"
    ],
    "url": "http://wm.com/webapp/game/game/shake?id=5629afd6d6f97f1f048b456e",
    "condition": {
        "type": "range",// range(积分范围大于), today(游戏开始前24小时内获得的积分大于), tag(标签,数组,与的关系)
        "value": 1
    },
    "reward": {
        "time": {
    ...
    "isPublished": true,
    "type": "shake",
    "nextRewardTime": "2015-11-03T00:00:00+08:00"
}
```
...
- Request Endpoint:
http://{server-domain}/games/{gameId}/shake/{memberId}
...
```
https://sandbox-api.quncrm.com/games/5618cb67d6f97f6e5f8b4569/shake/5615d0a4d6f97f801a8b4567
```
...
```
{
    ...
    "url": "https://staging.quncrm.com/webapp/game/game/index?id=561787a9d6f97fd6318b456a",
    "condition": {
        "type": "tag",
        "value": []
    },
    "reward": {
        "time": {
            "from": 0, //从当日0点到开始时间的毫秒数
            "to": 86340000 //从当日0点到结束时间的毫秒数
        },
        "gifts": [
            {
                "type": "score",
    ...
    "isPublished": true,
    "type": "shake",
    "token": "4856d6ce-7310-11e5-9c95-001ec9532058",//如果会员没有资格，已经抢过,当日活动是否结束或者当日的奖项已经抢完，则为空
    "isMemberSuitable": true,//会员是否有资格
    "isMemberPlayed": false,//会员当日是否已经摇过
    "isGiftEmpty": false,//当日奖项是否已经抢完
    "isExpired": false,//当日活动是否结束
    "left_milliseconds": 12000,//当天倒计时,单位为毫秒,如果当日没有摇一摇活动或者活动已经开始都为0
    "nextRewardTime": "2015-10-16T06:00:00+08:00"
}
```
...
| Name | Type | Required | Example | Description |
| ---- | ---- | -------- | ------- | ----------- |
| channelId | string | No | 5618cb67d6f97f6e5f8b4789 | channel id |
| token | string | Yes | c7cc7601-7240-11e5-9da4-b083fe8f26c6 | return in shake info |
...

{
    ...
    "game_token": "c7cc7601-7240-11e5-9da4-b083fe8f26c6"
}
```
...
```
{
    "score": "56809917d6f97f6f1f8b4567", // 获得优惠券(优惠券ID)
    "type":"coupon",
    "name":"优惠券名称"，
    "win": true // 是否中奖
}
...
| Name | Type | Required | Example | Description |
| ---- | ---- | -------- | ------- | ----------- |
| accountId | string | Yes | "55d6cb8be9c2fb022c8b4579" | accountId |

- Request Example

```
http://wm.com/api/management/channel/wechat-payment_message?accountId=55d6cb8be9c2fb022c8b4579
```
...
| Name | Type | Required | Example | Description |
| ---- | ---- | -------- | ------- | ----------- |
| tradeType | string | Yes | "JSAPI(公众号支付),NATIVE(扫码支付) | 支付类型 |
| openId | string | Yes | "2014102700014769" | 买家微信openId |
| ip | string | Yes | "192.168.222.91" | 买家终端IP |
| name | string | Yes | "asdadad" | 服务名称 |
| extraRequirement | string | Yes | "" | 订单详情 |
| orderNumber | string | Yes | "T0001" | 服务订单编号 |
| price | string | Yes | "100" | 订单金额 |
| orderedAt | string | Yes | "1420041600000" | 订单时间 |
...
{
    "tradeType": "NATIVE",
    "openId":"2014102700014769",
    "ip":"10010000",
    "name":"20141027014769",
    "extraRequirement":"apiclient_cert.p12",
    "orderNumber":"apiclient_cert.pem",
    "price":"100",
    "orderedAt":"rootca.pem"
}
```
...
| ---- | ---- | -------- | ------- | ----------- |
| orderNumber | string | Yes | "T0001" | 服务订单编号 |
| refundNumber | string | Yes | 100 | 退款编号 |
| expectedAmount | string | Yes | "100" | 订单金额 |
| realAmount | string | Yes| "100" | 退款金额 |
| name | string | Yes | "name" | 操作员 |
